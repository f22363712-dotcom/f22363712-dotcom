...
- **AI Automation**：用 AI、脚本和工作流工具把重复决策、信息筛选和内容处理自动化。
- **Knowledge Systems**：以 Obsidian 为核心，搭建能沉淀文章、项目、情报和复盘的个人知识系统。
- **Personal Products**：围绕财富规划、关系管理和个人效率做小型数字产品实验。
- **Writing / Digital Garden**：把工具实践、技术选择和长期思考写成文章。
...
我在这里记录工具实践、AI 自动化、知识管理和国际政经观察：

**[岳峙亭渊 | 数字书斋](https://www.wisdomprime.com/)**
...
**Languages / Backend**  
`Python` · `JavaScript` · `FastAPI` · `Flask` · `SQLite`

**AI / Automation**  
`Claude Code` · `DeepSeek` · `n8n` · `Windmill` · `AnySearch` · `MCP`

**Knowledge / Writing**  
`Obsidian` · `Templater` · `Local REST API` · `Markdown` · `Astro`

**Infra / Product**  
`Docker` · `GitHub` · `Railway` · `PWA` · `GitHub Actions`
...
- 把个人知识库变成可持续运行的自动化系统
- 用 Vibe Coding 快速验证个人产品想法
- 构建 AI 工具链：从信息收集、决策、写作到发布
- 关注 AI 技术进展与国际政治经济之间的相互影响
